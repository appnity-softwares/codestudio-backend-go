...
func SeedPracticeProblems(creator models.User) {
	...
	problems := []models.PracticeProblem{
		...
		},
		{
			...
			Difficulty:  "MEDIUM",
			Category:    "Algorithms",
			StarterCode: "func binarySearch(nums []int, target int) int { return -1 }",
		...
		},
		{
			...
			Description: "Check if a sequence of brackets is valid.",
			Difficulty:  "MEDIUM",
			Category:    "Stacks",
		...
		},
		{
			...
			StarterCode: "func uniquePaths(m int, n int) int { return 0 }",
		...
		},
		{
			ID:          uuid.New().String(),
			Title:       "Two Sum II",
			Description: "Two sum in a sorted array.",
			Difficulty:  "MEDIUM",
			Category:    "Arrays",
			StarterCode: "def twoSum(numbers, target): pass",
		...
		},
		{
			ID:          uuid.New().String(),
			Title:       "House Robber",
			Description: "Maximize profit from non-adjacent houses.",
			Difficulty:  "MEDIUM",
			Category:    "Dynamic Programming",
